...
while True:
    ...
    for c in cnts:
        ...
        text = "Find Target! save as E:\Pythonlook"
        print("Find Target!")
    ...
    if flat == 1:  # 设置一个标签，当有运动的时候为1
        fn = 'E:\Pythonlook\shot%d.jpg' % (shot_idx)
